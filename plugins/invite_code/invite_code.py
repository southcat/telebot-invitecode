...
def invite_code(bot, message):
    ...
    if yanzheng2(bot,message["from"]["id"]) == 0:                           #判断用户是否获取过
        ...
        if sysl == 0:                                                   #判断数量是否为0 比较容易理解
            ...
            invite_code1 = code(bot=bot)                                                                   #函数赋值
            status = bot.sendChatAction(message["chat"]["id"], "typing")                            #显示发送状态
